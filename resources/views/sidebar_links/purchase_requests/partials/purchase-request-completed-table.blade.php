<div>
    ...
    {{-- :class="tab === 'purchase_request_pending' ? 'border rounded-b-md p-4 bg-gray-50' : 'border border-top-0 rounded-b-md p-4 bg-gray-50'" --}}
<table class="w-full table-auto">
    ...
    <tbody class="text-gray-600 text-sm bg-white">
        @forelse ($purchaseRequestCompletes as $purchaseRequest)
