        ...
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            <section class="container grid gap-5 mx-auto px-4">
                <div class="bg-white p-5 rounded-md">
                    <h1 class="mb-2 font-semibold text-lg text-gray-800">User Management</h1>
                    <p class="text-sm text-gray-700 bg-blue-100 p-3 rounded-lg">
                        Manage user accounts, define roles and permissions, and maintain secure access control
                        to ensure efficient and safe system operations.
                    </p>
                            ...
                            <tbody class="text-gray-600 text-sm">
                                @forelse ($users as $user)
                                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                                        ...
                                        <td class="py-3 px-6 text-left">{{ $user->organization->organization_name }}</td>
                                        ...
                                        <td class="py-3 px-6 text-center">
                                            <div class="flex item-center justify-center">
                                                ...
                                                <div>
                                                    @include('sidebar_links.users.modals.confirm-delete-user')
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
